 ...
 * generator to use from the default set. Also, enables the use of reflection if
 * the user has constructed a more powerful generator of their own.
 *
...
public class GeneratorPanel<E> extends Panel {
    ...
    /**
     * Store generator classes here. Key = user string. Value = the class which
     * ultimately extends Generator<E>.
     */
