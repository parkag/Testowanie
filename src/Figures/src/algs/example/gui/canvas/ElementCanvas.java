...
/**
 * AWT Canvas subclass to be able to draw a set of elements as defined by an
 * ArrayList of E elements.
 * <p>
...
public abstract class ElementCanvas<E> extends Canvas {
     ...
     *
     * Because of the way Java AWT works, you can't create an Image object until
     * the Application is visible; however, this leads to a catch-22, so we
     * perform "lazy computation" by creating the image once it is really
     * needed.
     */
     ...
     *
     * Decouple from the canvas constructor so it can be executed separately as
     * needed.
     *
     * @param drawing
     */
    ...
    /**
     * Draws the current state to an off-screen buffer and then requests a
     * repaint of the canvas to show it to the user.
     */
