 ...
 *
 * Note that all points in the KDTree are still in Cartesian coordinates so this
 * decorator properly inverts y coordinate when drawing based upon the height of
 * the canvas.
 *
