...
/**
 * Maintains AWT information about the regions associated with each point in the
 * KD tree.
 *
 * Ensures that drawing lines will be within their respective boundaries as the
 * KD tree is drawn.
 *
...
public class DrawingInfo {
    ...
    public String toString() {
        return "H:" + minHorizontal + "," + maxHorizontal + ", V:" + minVertical + "," + maxVertical;
    }
