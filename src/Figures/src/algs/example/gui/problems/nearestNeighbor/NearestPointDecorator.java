...
/**
 * Decorates the nearest point by drawing both it and the current point with a
 * red line connecting the two.
 *
...
public class NearestPointDecorator extends DrawingDecorator {
    ...
    /**
     * Must properly adjust for height to convert Cartesian coordinates into
     * AWT.
     */
    @Override
