 ...
 * <p>
 * The common etiquette is that the start of a line segment has the higher
 * y-value than the end of the line segment; note for horizontal line segments
 * the start will be the one whose x-value is smaller (i.e., left-to-right).
 *
...
public interface ILineSegment {
    ...
    /**
     * Return the coordinate value of the Start of the line segment as a
     * two-dimensional IPoint.
     *
    ...
    /**
     * Return the coordinate value of the End of the line segment as a
     * two-dimensional IPoint.
     *
    ...
    /**
     * Return the intersection point with the given Line Segment, or null if no
     * such intersection.
     *
     * Note that for overlapping line segments, it is unclear WHAT should be
     * returned.
     */
    ...
    /**
     * Determine if the given point is to the right of the line segment, if we
     * view the line segment from the lower (end) point to the upper (start)
     * point.
     */
    public boolean pointOnRight(IPoint p);

    /**
     * Determine if the given point is to the left of the line segment, if we
     * view the line segment from the lower (end) point to the upper (start)
     * point.
     */
    ...
    /**
     * Return the y-intercept of the line segment if it were extended to be a
     * full line. For vertical lines, Double.NaN
     */
    double yIntercept();
}
