 ...
 * <p>
 * Tries to honor the 'size' parameter when generating. That is, if there are
 * more points in the file than 'size' it will be truncated. However if the file
 * contains fewer points, the returned array will be smaller than requested.
 * <p>
...
public class LoadFromFileGenerator extends Generator<IPoint> {
    ...
    /**
     * Provide reflective behavior to construct instance of generator given an
