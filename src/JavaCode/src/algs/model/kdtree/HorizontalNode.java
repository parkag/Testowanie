 ...
 * vertical line at the given y-coordinate.
 * <p>
 * This class is intended as a simpler, optimized implementation of
 * {@link DimensionalNode} for two dimensional KD trees.
 * <p>
 * Ancestors via the left son are those points which are above the point
 * represented by this node. Ancestors via the right son are those points which
 * are below the point represented by this node.
 *
