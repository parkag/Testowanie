 ...
 * <p>
 * This class is intended as a simpler, optimized implementation of
 * {@link DimensionalNode} for two dimensional KD trees.
 *
...
public abstract class TwoDNode {
    ...
    /**
     * Stores the coordinate value to be used for dividing the plane either
     * vertically or horizontally
     * <p>
     * Note the initial region associated with this {@link TwoDNode} object is
     * unbounded and will only be set properly when it is added into the tree.
     *
     ...
     *
     * @return true if this node represents a VerticalNode in the TwoDTree;
     * false otherwise.
     */
     ...
     * <p>
     * For vertical nodes, below is clear. For horizontal nodes, a true value
     ...
     * <p>
     * For {@link VerticalNode}, below is clear. For {@link HorizontalNode}, a
     * true value for below is interpreted as being left.
     *
     ...
     * target than min[0]; if so return that IPoint and update min[0]
     * accordingly.
     *
     *
     * @param target the target in raw optimized form
     * @param min minimum distance found so far
     * @return existing point in tree that is closest; if null, then no point in
     * the tree is closer than min[0] from the given IPoint; if non-null, then
     * min[0] is updated to reflect this closer distance.
     */
    ...
    /**
     * Compute perpendicular distance to given target point based upon whether
     * we are a {@link VerticalNode} or {@link HorizontalNode}.
     * <p>
     * This logic is delegated to the appropriate subclass.
     *
     * @param target point to which distance is computed along perpendicular
     * axis.
     */
     ...
     * @return appropriate {@link TwoDNode} subclass (either
     * {@link VerticalNode} or {@link HorizontalNode})
     */
     ...
     * @param results non-null ArrayList<IPoint> into which located points are
     * inserted.
    ...
    /**
     * Locate all points within the TwoDTree that fall within the given
     * rectangle and use given visitor as the computation to perform on that
     * node.
     *
    ...
    /**
     * Helper method to record all descendant nodes in the tree rooted at given
     * node.
     */
