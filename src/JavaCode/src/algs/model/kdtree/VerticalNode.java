...
/**
 * Represents a node in the 2D-tree that partitions the space by means of a
 ...
 * <p>
 * Ancestors via the left son are those points which are to the left of the
 * point represented by this node. Ancestors via the right son are those points
 * which are to the right of the point represented by this node.
 *
