...
public class DimensionalComparator implements Comparator<IMultiPoint> {
     ...
     * two points have the same dimensionality. Indeed, if this method is
     * invoked with an IMultiPoint whose dimensionality is less than d, then the
     * result is undetermined (it may throw a runtime exception it may not).
     *
