...
public class TwoDTree {
    ...
    /**
     * Return the root of the TwoDTree, which is guaranteed to be a Vertical
     * Node.
     */
     ...
     * parents).
     *
     * Note that you will have to inspect the dimension for the TwoNode to
     * determine if this is a Below or an Above parent.
     */
     ...
     * does not have 'boundless' space associated with it.
     * <p>
     * Note that
     *
     * @see {@link #updateRectangles()} should always be called after invoking
     * this function, to ensure rectangles are all properly computed.
     */
     ...
     * <p>
     * Only returns null if the tree was initially empty or if the target is
     * null. Otherwise, must return some point that belongs to the tree.
     *
     ...
     * @return {@link ArrayList} of {@link IPoint} objects found within the
     * space.
     */
    ...
    /**
     * Locate all points within the TwoDTree that fall within the given
     * rectangle and visit those nodes via the given visitor.
     *
