 ...
 * altered. Note, however, that altering the tree structure *during* a traversal
 * will lead to non-determined behavior.
 *
...
public abstract class TwoDTraversal implements IVisitTwoDNode {
    ...
    /**
     * This drain is never invoked during the node-by-node traversal and it is
     * implemented here to avoid subclasses from mistakenly thinking that they
     * need to implement it. We mark this method as final to prevent such
     * attempts.
     *
     * @param node Node to be drained, though this is never invoked during the
     * traversal.
     */
