...
public class Selection {
     ...
     * @exception ArrayIndexOutOfBoundsException if either pos1 or pos2 is
     * invalid
     */
     ...
     * @exception NullPointerException if ar is null or references an empty
     * array.
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * In linear time, group an array into two parts, those less than a certain
     * value (left), and those greater than or equal to a certain value (right).
     *
     * @param ar An array of Comparable objects
     ...
     * @param pivotIndex index around which the partition is being made.
     * @param comparator Externalize the comparison of two objects into this
     * method.
     * @return location of the pivot index properly positioned.
     */
    @SuppressWarnings("unchecked")
     ...
     * @param left The left-bounds within which to search (0 &le; left &lt;
     * ar.length)
     * @param right The right-bounds within which to search (0 &le; right &lt;
     * ar.length)
     * @return index of the pivot within the ar[] array (0 &le; index &lt;
     * ar.length)
     */
    @SuppressWarnings("unchecked")
    ...
    /**
     * Select the kth value in an array (1 &le; k &le; right-left+1) through
     * recursive partitioning.
     *
     * Note that ar[] is altered during the execution of this method. left must
     * be &le; right. Built in comparator is used.
     *
     * @param ar Array of Comparable objects
     * @param k The position in sorted order of the desired location (1 &le; k
     * &le; right-left+1)
     * @param left The left-bounds within which to search (0 &le; left &lt;
     * ar.length)
     * @param right The right-bounds within which to search (0 &le; right &lt;
     ...
     *
     * Note that ar[] is altered during the execution of this method. left must
     * be &le; right. Externally provided comparator is used.
     *
     ...
     *
     * @param ar Array of Comparable objects
     * @param left The left-bounds within which to sort (0 &le; left &lt;
     * ar.length)
     * @param right The right-bounds within which to sort (0 &le; right &lt;
     * ar.length)
