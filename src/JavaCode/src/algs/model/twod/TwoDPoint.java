...
public class TwoDPoint implements IPoint, IMultiPoint {
     ...
     * <p>
     * No serious error handling is considered, so be wary of passing in invalid
     * values.
     *
     ...
     * @exception IllegalArgumentException if invoked with an argument that does
     * not represent a two-dimensional point.
     */
