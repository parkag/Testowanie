 ...
 * <p>
 * This interface is the d-dimensional counterpart to {@link IPoint}. Indeed the
 * classes which implement {@link IPoint} should also implement
 * {@link IMultiPoint} to enable two-dimensional data to be processed in the
 * same way that d-dimensional data can be.
 * <p>
 *
...
public interface IMultiPoint {
     ...
     *
     * @param dx the dimension 1 &le; dx &le; dimensionality() for the desired
     * coordinate.
     */
     ...
     *
     * @param imp other IMultiPoint to which we want to compute the Euclidean
     * distance.
     */
